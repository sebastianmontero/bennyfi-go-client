...
func (m *EosRexRemoteContract) MoveRoundFromSavings(roundId uint64) (string, error) {
	return m.ExecAction(fmt.Sprintf("%v@open", m.ContractName), "mvfrmsvngsrn", roundId)
}

func (m *EosRexRemoteContract) SellRoundRex(roundId uint64) (string, error) {
	return m.ExecAction(fmt.Sprintf("%v@open", m.ContractName), "sellrexrn", roundId)
}

func (m *EosRexRemoteContract) WithdrawRoundRex(roundId uint64) (string, error) {
	return m.ExecAction(fmt.Sprintf("%v@open", m.ContractName), "withdrwrexrn", roundId)
}

func (m *EosRexRemoteContract) MoveFromSavings(callCounter uint64) (string, error) {
	return m.ExecAction(fmt.Sprintf("%v@open", m.ContractName), "mvfrmsavings", callCounter)
}

func (m *EosRexRemoteContract) SellRex(callCounter uint64) (string, error) {
	return m.ExecAction(fmt.Sprintf("%v@open", m.ContractName), "sellrex", callCounter)
}

func (m *EosRexRemoteContract) WithdrawRex(callCounter uint64) (string, error) {
	return m.ExecAction(fmt.Sprintf("%v@open", m.ContractName), "withdrawrex", callCounter)
}

func (m *EosRexRemoteContract) TstLapseTime(roundId uint64) (string, error) {
	actionData := struct {
		RoundId     uint64
		CallCounter uint64
...
func (m *EosRexRemoteContract) TstSetLastNotifiedTime(roundId uint64, lastNotifiedTime eos.TimePoint) (string, error) {
	actionData := struct {
		RoundId          uint64
...
func (m *EosRexRemoteContract) GetStake(roundID uint64) (*Stake, error) {
...
func (m *EosRexRemoteContract) GetLastStake() (*Stake, error) {
	stakes, err := m.GetStakesReq(&eos.GetTableRowsRequest{
		Reverse: true,
		Limit:   1,
	})
...
func (m *EosRexRemoteContract) GetStakesReq(req *eos.GetTableRowsRequest) ([]Stake, error) {
...
func (m *EosRexRemoteContract) GetStakesByRexStateAndId(state eos.Name) ([]Stake, error) {
...
func (m *EosRexRemoteContract) FilterStakesByRexStateAndId(req *eos.GetTableRowsRequest, state eos.Name) error {
